...
<body>
	...
	<div class="container text-justify">
		...
		<div class="row d-flex justify-content-center about-p-margin about-rwd-text-image-merger-1">
			<div class="col-md-5">
				<div class="about-p-image">
					<div class="about-rwd-overlay">
						<img src="assets/about-1.JPG">
					</div>
				</div>
			</div>
			<div class="col-md-7 about-p-container">
				<div class="about-rwd-text">
					<div class="about-p-text about-p-title about-p-title-bg">
						<h2>緣起</h2>
					</div>
					<div class="about-p-text about-p-text-margintop">
						<p>
							本宮自84年6月7日開始建造，建了30幾年才完工，<br />
							建到一半因為資金不足，只好等籌到錢才能繼續建造，<br />
							沒有靠外資，全是靠著志工一起築出宮裡的每個細節，<br />
							所以才建了那麼久，從以前在東區那只有一間小小間的廟宇，<br />
							到後來搬到仁德區這裏，才開始有預算和時間來蓋起這間宮廟。<br />
							直到去年才建教完畢。<br />
							即便如此，目前二樓還是尚未完工，<br />
							所以二樓還不開放公眾參觀。<br />
						</p>
		...
		<hr class="about-hr about-rwd-hr">
		<div class="about-rwd-visibility">
			<div class="row d-flex justify-content-center about-p-margin about-rwd-text-image-merger-2">
				<div class="col-md-5">
					<div class="about-p-image">
						<div class="about-rwd-overlay">
				...
				<div class="col-md-7 about-p-container">
					<div class="about-rwd-text">
						<div class="about-p-text about-p-text-margintop">
							<p>
								裏面的裝潢基本上都是由他們自己共同一手打造，<br />
								包括所有的窗戶，雕刻，壁畫等。<br />
								聖海宮的整個建築設計和其他的廟宇完全不一樣。
							</p>
						</div>
					</div>
				</div>
		...
		<hr class="about-hr about-rwd-hr">
		<div class="row d-flex justify-content-center about-p-margin about-rwd-text-image-merger-3">
			<div class="col-md-5">
				<div class="about-p-image">
					<div class="about-rwd-overlay">
			...
			<div class="col-md-7 about-p-container">
				<div class="about-rwd-text">
					...
					<div class="about-p-text about-p-text-margintop about-p-rwd-mazhu-text">
						<p>
							其實就是大名鼎鼎的媽祖，<br />
							從宋、元時代到今天，福建及廣東一帶的沿海漁民。<br />
							每當出海捕魚或是遇上風浪險惡，<br />
							一定會祈禱媽祖保佑平安，現在台灣民眾及海外華人，<br />
							雖不一定出海捕魚或行船，但仍維持傳統信仰媽祖。<br />
							「媽祖」，原名林默娘，傳說中聽到有人呼救，<br />
							就立即現身海上救苦救難，因此成為中國的海上保護神，<br />
							受到百姓景仰。福建、台灣沿海一帶民間稱為「媽祖」，<br />
							而歷代朝廷也為了鼓勵百姓開拓南洋，<br />
							常常加封媽祖許多封號，<br />
							例如「天后」、「天上聖母」等等。 <br />
						</p>
