...
<body>
	...
	<div class="container text-justify">
		...
		<nav class="navbar navbar-expand-md navbar-light bg-light navbar-custom">
			...
			<div class="collapse navbar-collapse" id="theNavbar">
				<ul class="navbar-nav ml-auto mx-auto">
					...
					<li class="nav-item navline dropdown active noselect">
		...
		<div class="row d-flex justify-content-center place-p-margin place-rwd-text-image-merger-1">
			<div class="col-md-5">
				<div class="place-p-image place-p-image-page-2">
					<div class="place-rwd-overlay">
						<img src="assets/sightspot3.jpg">
					</div>
				</div>
			</div>
			<div class="col-md-7 place-p-container">
				<div class="place-rwd-text">
					<div class="place-p-text place-p-title place-p-title-bg">
						<h2>TJCOS台鉅美妝觀光工廠</h2>
					</div>
					<div class="place-p-text place-p-text-page-2 place-p-text-margintop">
						<p>
							位在台南仁德的TJCOS台鉅美妝觀光工廠，<br />
							結合彩妝、保養、DIY與休閒於一身，<br />
							是全台第一家以化妝品為主題的觀光工廠。<br />
							佔地廣闊的台鉅美妝觀光工廠，<br />
							戶外設置芳療庭園供民眾參觀、<br />
							認識各種香草植物，
						</p>
		...
		<div class="place-rwd-visibility">
			<div class="row d-flex justify-content-center place-p-margin place-rwd-text-image-merger-2">
				<div class="col-md-5">
					<div class="place-p-image place-p-image-page-2">
						<div class="place-rwd-overlay">
							<img src="assets/sightspot3-1.jpg">
						</div>
					</div>
				</div>
				<div class="col-md-7 place-p-container">
					<div class="place-rwd-text">
						<div class="place-p-text place-p-text-page-2 place-p-text-margintop">
							<p>
								館內則帶領民眾<br />
								一窺台鉅歷年來的發展，並展示為不同國家<br />
								設計的彩妝盒，造型多變又搶眼，令人印象深刻。<br />
								同時規劃多變化的DIY活動，<br />
								讓民眾可自行挑選組合喜愛的彩妝。<br />
								商場則販賣各式彩妝保養品，設置大明星化妝間的試妝台，<br />
								讓你盡情試用台鉅出品的彩妝產品，<br />
								絕對是許多女孩到台南必遊的觀光工廠！
							</p>
						</div>
		...
		<div class="place-visibility">
			<div class="row d-flex justify-content-center place-p-margin-page1-2 place-rwd-text-image-merger-2">
				<div class="col-md-7 place-p-container">
					<div>
						<div class="place-p-text place-p-text-page-2 place-p-text-margintop-float-right">
							<p>
								館內則帶領民眾<br />
								一窺台鉅歷年來的發展，並展示為不同國家<br />
								設計的彩妝盒，造型多變又搶眼，令人印象深刻。<br />
				...
				<div class="col-md-5">
					<div class="place-p-image place-p-image-left place-p-image-page-2">
						<div class="place-rwd-overlay">
							<img src="assets/sightspot3-1.jpg">
						</div>
					</div>
		...
		<div class="place-info">
			<div class="place-info-bg">
				<div class="place-info-text">
					<p>
						地址：台南市仁德區中正路三段589號<br />
						電話：06 205 2013<br />
						服務時間：09:00~17:00（每周二休館)<br />
					</p>
				</div>
			</div>
		</div>
