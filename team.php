        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <div class="team-img-rounded">
                    <img src="assets/team-sammy.jpg">
                </div>
                <hr class="team-hr">
                <div class="team-p-title">
                    <p> UI/UX Design <br />
                    UI/UX 設計</p>
                </div>
                <div class="team-p-text">
                    <p>4070X010 王郁舜</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="team-img-rounded">
                    <img src="assets/team-kat.jpg">
                </div>
                <hr class="team-hr">
                <div class="team-p-title">
                    <p> Web Developer <br />
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <span class="bottom-align-text">
                        <a class="footer-right-link" href="team.php" target="_blank" style="color: #6D0C09;"> @team cybertruck2077 </a>
                        <br />
